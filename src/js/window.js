...
document.getElementById("help").addEventListener("mouseleave", () => {
...
document.getElementById("titlebar-close").addEventListener("click", () => getCurrentWindow().minimize());
...
let timeoutID = 0;
let delay = 500;
getCurrentWindow().listen(window.__TAURI__.event.TauriEvent.WINDOW_MOVED, ({ event, payload }) => {
